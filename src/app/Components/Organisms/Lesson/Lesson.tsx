...
const Lesson = (data: { data: lessonsDataProps }) => {
    ...
    const lessonStatusButtonlabel = ['started' , 'finished' , 'sent'];
    console.log(lessonStatusButtonlabel[0] === isStarted)
            ...
            <div className={' flex flex-col gap-7'}>
                ...
                <div>
                    <div className={'flex flex-row justify-center items-center text-[15px]'}>
                        ...
                        <div className={`${ isStarted !== lessonStatusButtonlabel[0]? 'opacity-30':''} flex flex-col justify-center items-center gap-2`}>
                        ...
                        <div className={`${ isStarted !== lessonStatusButtonlabel[1]? 'opacity-30':''} flex flex-col justify-center items-center gap-2`}>
                            <Icon iconContent={'/icons/utils/done.svg'} iconSize={34} iconAlt={''}
                                  containerClass={`block border-[1px] border-white w-[45px] text-blue-dark rounded-square text-[30px] flex flex-nowrap justify-center`}/>
                        ...
                        <div className={`${ isStarted !== lessonStatusButtonlabel[2]? 'opacity-30':''} flex flex-col justify-center items-center gap-2`}>
                            <Icon iconContent={'/icons/utils/done.svg'} iconSize={34} iconAlt={''}
                                  containerClass={`block border-[1px] border-white w-[45px] text-blue-dark rounded-square text-[30px] flex flex-nowrap justify-center`}/>
